      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-5">Từ Đam Mê Đến Sứ Mệnh</h2>
            <div className="space-y-4 text-gray-600 text-sm leading-relaxed">
              <p>TARA NEST được thành lập năm 2019 bởi một nhóm những người yêu sức khỏe và trân trọng các giá trị tự nhiên. Xuất phát từ câu chuyện cá nhân của người sáng lập – khi chứng kiến sức khỏe của cha mẹ được cải thiện rõ rệt nhờ yến sào – chúng tôi quyết tâm xây dựng một thương hiệu yến sào đáng tin cậy, minh bạch và chất lượng.</p>
              <p>Chúng tôi tin rằng thiên nhiên có đủ những gì cơ thể cần. Sứ mệnh của TARA NEST là kết nối nguồn dưỡng chất quý giá từ tổ yến tự nhiên đến tay từng gia đình Việt, với quy trình kiểm soát chất lượng nghiêm ngặt và giá cả minh bạch.</p>
              <p>Hơn 5 năm xây dựng và phát triển, TARA NEST tự hào đã phục vụ hơn 10.000 khách hàng trên toàn quốc với tỷ lệ hài lòng 4.9/5 sao.</p>
            </div>
          </div>
      ...
      <section className="bg-primary-600 text-white py-14">
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={label}>
              <div className="text-3xl md:text-4xl font-bold text-white mb-2">{num}</div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            {team.map(m => (
              <div key={m.name} className="bg-white rounded-2xl p-6 shadow-sm text-center">
